    ...
    public static void main(String[] args) {
        ...
        while (userChoseParsed != MAX_MENU_OPCOES){ //opcao != 'Sair'
            ...
            switch(userChoseParsed){
                case 1:
                    System.out.println(carregarDados(lista) + " participantes "
...
/*
private static Integer carregarDados()
    Entradas: void
 ...
 */  
    private static Integer carregarDados(Participante[] lista){
        ...
        for (int i = numParticipantes; i < MAX_PARTICIPANTES; i++){
            lista[i] = null;
        }
...
/*
private static void gerarBlocoDeNotas(Participante[] lista)
    Entradas: Participantes[] lista - o vetor com as classes Participante
    Saidas: void
